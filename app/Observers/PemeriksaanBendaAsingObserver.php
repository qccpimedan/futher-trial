...
class PemeriksaanBendaAsingObserver
{
    /**
     * Handle the PemeriksaanBendaAsing "updated" event.
     */
    public function updated(PemeriksaanBendaAsing $pemeriksaanBendaAsing)
    {
        $original = $pemeriksaanBendaAsing->getOriginal();
        $changes = $pemeriksaanBendaAsing->getChanges();
