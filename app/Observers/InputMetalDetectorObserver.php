...
class InputMetalDetectorObserver
{
    /**
     * Handle the InputMetalDetector "updated" event.
     */
    public function updated(InputMetalDetector $inputMetalDetector)
    {
        $original = $inputMetalDetector->getOriginal();
        $changes = $inputMetalDetector->getChanges();
        ...
        if (!empty($fieldsChanged)) {
            ...
            InputMetalDetectorLog::create([
                ...
                'input_metal_detector_id' => $inputMetalDetector->id,
                'input_metal_detector_uuid' => $inputMetalDetector->uuid,
