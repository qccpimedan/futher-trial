...
class ThermometerObserver
{
    /**
     * Handle the Thermometer "updated" event.
     */
    public function updated(Thermometer $thermometer)
    {
        $original = $thermometer->getOriginal();
        $changes = $thermometer->getChanges();
