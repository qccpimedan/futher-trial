...
class ProsesMarinadeObserver
{
    /**
     * Handle the ProsesMarinadeModel "updated" event.
     */
    public function updated(ProsesMarinadeModel $prosesMarinadeModel)
    {
        $original = $prosesMarinadeModel->getOriginal();
        $changes = $prosesMarinadeModel->getChanges();
        ...
        if (!empty($fieldsChanged)) {
            ...
            ProsesMarinadeLog::create([
                'uuid' => \Illuminate\Support\Str::uuid(),
                'proses_marinade_id' => $prosesMarinadeModel->id,
                'proses_marinade_uuid' => $prosesMarinadeModel->uuid,
