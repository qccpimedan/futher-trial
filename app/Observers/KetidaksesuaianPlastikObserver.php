...
class KetidaksesuaianPlastikObserver
{
    /**
     * Handle the KetidaksesuaianPlastik "updated" event.
     */
    public function updated(KetidaksesuaianPlastik $ketidaksesuaianPlastik)
    {
        $original = $ketidaksesuaianPlastik->getOriginal();
        $changes = $ketidaksesuaianPlastik->getChanges();
        ...
        if (!empty($fieldsChanged)) {
            ...
            KetidaksesuaianPlastikLog::create([
                ...
                'ketidaksesuaian_plastik_uuid' => $ketidaksesuaianPlastik->uuid,
