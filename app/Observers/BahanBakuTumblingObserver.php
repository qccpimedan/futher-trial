...
class BahanBakuTumblingObserver
{
    /**
     * Handle the BahanBakuTumbling "updated" event.
     */
    public function updated(BahanBakuTumbling $bahanBakuTumbling)
    {
        $original = $bahanBakuTumbling->getOriginal();
        $changes = $bahanBakuTumbling->getChanges();
        ...
        if (!empty($fieldsChanged)) {
            ...
            BahanBakuTumblingLog::create([
                'uuid' => \Illuminate\Support\Str::uuid(),
                'bahan_baku_tumbling_id' => $bahanBakuTumbling->id,
                'bahan_baku_tumbling_uuid' => $bahanBakuTumbling->uuid,
