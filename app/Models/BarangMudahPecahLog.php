...
class BarangMudahPecahLog extends Model
{
    use HasFactory;

    protected $table = 'barang_mudah_pecah_logs';

    protected $fillable = [
        'uuid',
        'barang_mudah_pecah_id',
        'barang_mudah_pecah_uuid',
        'user_id',
        'user_name',
        'user_role',
        'aksi',
    ...
    // Relasi ke BarangMudahPecah
    public function barangMudahPecah()
    {
        return $this->belongsTo(BarangMudahPecah::class, 'barang_mudah_pecah_id');
    }
