...
class ReboxLog extends Model
{
    protected $table = 'rebox_logs';
    ...
    /**
     * Relasi ke tabel reboxes
     */
    public function rebox()
    {
        return $this->belongsTo(Rebox::class, 'rebox_id');
    }
