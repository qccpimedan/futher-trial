...
class BeratProdukBagLog extends Model
{
    use HasFactory;

    protected $table = 'berat_produk_bag_logs';

    protected $fillable = [
        'uuid',
        'berat_produk_bag_id',
        'berat_produk_bag_uuid',
        'user_id',
        'field_yang_diubah',
        'nilai_lama',
        'nilai_baru',
    ...
    {
        return $this->belongsTo(BeratProdukBag::class, 'berat_produk_bag_id');
    }
