...
class KetidaksesuaianBendaAsingLog extends Model
{
    use HasFactory;

    protected $table = 'ketidaksesuaian_benda_asing_logs';

    protected $fillable = [
        'uuid',
        'ketidaksesuaian_benda_asing_id',
        'ketidaksesuaian_benda_asing_uuid',
        'user_id',
        'user_name',
        'user_role',
        'aksi',
    ...
    // Relasi ke KetidaksesuaianBendaAsing
    public function ketidaksesuaianBendaAsing()
    {
        return $this->belongsTo(KetidaksesuaianBendaAsing::class, 'ketidaksesuaian_benda_asing_id');
    }
    ...
    public static function getFieldNames()
    {
        return [
            ...
            'jenis_kontaminan' => 'Jenis Kontaminan',
            'jumlah_produk_terdampak' => 'Jumlah Produk Terdampak',
            'tahapan' => 'Tahapan',
