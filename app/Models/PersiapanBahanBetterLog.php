...
class PersiapanBahanBetterLog extends Model
{
    protected $table = 'persiapan_bahan_better_logs';
    
    protected $fillable = [
        'uuid',
        'persiapan_bahan_better_id',
        'persiapan_bahan_better_uuid',
        'user_id',
        'user_name',
        'user_role',
        'aksi',
    ...
    /**
     * Relasi ke tabel persiapan_bahan_better
     */
    public function persiapanBahanBetter()
    {
        return $this->belongsTo(PersiapanBahanBetter::class, 'persiapan_bahan_better_id');
    }
    ...
    public static function getFieldNames()
    {
        return [
            'id_produk' => 'Produk',
            'id_better' => 'Better',
            'berat_better' => 'Berat Better',
            'suhu_air' => 'Suhu Air',
            'sensori' => 'Sensori',
            'kode_produksi_produk' => 'Kode Produksi Produk',
            'kode_produksi_better' => 'Kode Produksi Better',
            'shift_id' => 'Shift',
            'tanggal' => 'Tanggal',
            'id_plan' => 'Plan'
        ];
