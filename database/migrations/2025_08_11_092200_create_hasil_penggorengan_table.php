...
return new class extends Migration
{
    ...
    {
        Schema::create('hasil_penggorengan', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('aktual_suhu_pusat');
            $table->enum('sensori', ['Baik', 'Kurang Baik', 'Tidak Baik'])->default('Baik');
            $table->date('tanggal');
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('hasil_penggorengan');
    }
};
