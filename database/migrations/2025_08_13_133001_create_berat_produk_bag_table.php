...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('berat_produk_bag', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('id_data_bag')->constrained('data_bag')->onDelete('cascade');
            $table->date('tanggal');
    ...
    {
        Schema::dropIfExists('berat_produk_bag');
    }
};
