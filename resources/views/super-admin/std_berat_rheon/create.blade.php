...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Tambah Standar Berat Rheon</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Form Tambah Standar Berat Rheon</h3>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <form action="{{ route('std-berat-rheon.store') }}" method="POST">
                                @csrf
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="std_adonan" class="form-control @error('std_adonan') is-invalid @enderror" value="{{ old('std_adonan') }}" required>
                                            @error('std_adonan')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="std_filler" class="form-control @error('std_filler') is-invalid @enderror" value="{{ old('std_filler') }}">
                                            @error('std_filler')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="std_after_forming" class="form-control @error('std_after_forming') is-invalid @enderror" value="{{ old('std_after_forming') }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="std_after_frying" class="form-control @error('std_after_frying') is-invalid @enderror" value="{{ old('std_after_frying') }}">
