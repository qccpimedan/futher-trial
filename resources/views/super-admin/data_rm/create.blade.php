{{-- filepath: resources/views/super-admin/data_rm/create.blade.php --}}
@extends('layouts.app')
@section('container')
                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Form Tambah Data RM</h3>
                        ...
                        <form action="{{ route('data-rm.store') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                @if(session('error'))
                                ...
                                <hr>
                                <h5 class="mb-3"><i class="fas fa-list"></i> Daftar Nama RM</h5>
                                ...
                                <div id="formContainer">
                                    ...
                                    <div class="card card-outline card-info mb-3" data-form-index="1">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label for="nama_rm_1">Nama RM <span class="text-danger">*</span></label>
                                                <input type="text" name="nama_rm[]" id="nama_rm_1" 
                                                       class="form-control @error('nama_rm.*') is-invalid @enderror" 
                                                       placeholder="Masukkan Nama RM" 
                                                       value="{{ old('nama_rm.0') }}" required>
                                                @error('nama_rm.*')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
    ...
    $('#addFormBtn').click(function() {
        ...
        const newForm = `
            <div class="card card-outline card-info mb-3" data-form-index="${formCounter}">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <label for="nama_rm_${formCounter}">Nama RM <span class="text-danger">*</span></label>
                        <input type="text" name="nama_rm[]" id="nama_rm_${formCounter}" 
                               class="form-control" 
                               placeholder="Masukkan Nama RM" 
                               required>
                    </div>
