...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-thermometer-half text-success"></i> Tambah Standar Suhu Pusat Roasting</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card card-primary card-outline shadow">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-plus-circle"></i> Form Tambah Standar Suhu Pusat Roasting</h3>
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form action="{{ route('std-suhu-pusat-roasting.store') }}" method="POST">
                                @csrf
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="std_suhu_pusat_roasting" 
                                                               ...
                                                               value="{{ old('std_suhu_pusat_roasting') }}" required>
