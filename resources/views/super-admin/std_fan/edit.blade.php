                ...
                <div class="col-12">
                    <div class="card card-primary card-outline shadow">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fas fa-edit"></i> Form Edit Std Fan</h3>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <form action="{{ route('std-fan.update', $stdFan->uuid) }}" method="POST">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="card card-outline card-info shadow">
                                    ...
                                    <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_plan" id="id_plan_std_fan" class="form-control" required>
                                                        ...
                                                        @foreach($plans as $plan)
                                                            <option value="{{ $plan->id }}" {{ $stdFan->id_plan == $plan->id ? 'selected' : '' }}>
                                                                {{ $plan->nama_plan }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_produk" id="id_produk_std_fan" class="form-control" required>
                                                        ...
                                                        @if($stdFan->produk)
                                                            <option value="{{ $stdFan->id_produk }}" selected>{{ $stdFan->produk->nama_produk }}</option>
                                                        @endif
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_suhu_blok" id="id_suhu_blok_std_fan" class="form-control" required>
                                                        ...
                                                        @if($stdFan->suhuBlok)
                                                            <option value="{{ $stdFan->id_suhu_blok }}" selected>{{ $stdFan->suhuBlok->suhu_blok }}</option>
                                                        @endif
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="form-label"><i class="fas fa-fan text-success"></i> Std Fan <span class="text-danger">*</span></label>
                                                    <div class="input-group">
                                                        <input type="text" name="std_fan" class="form-control @error('std_fan') is-invalid @enderror" 
                                                               value="{{ old('std_fan', $stdFan->std_fan) }}" placeholder="Masukkan std fan" required>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="std_fan_2" class="form-control @error('std_fan_2') is-invalid @enderror" 
                                                               value="{{ old('std_fan_2', $stdFan->std_fan_2) }}" placeholder="Masukkan std fan 2" required>
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">%</span>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="std_lama_proses" class="form-control @error('std_lama_proses') is-invalid @enderror" 
                                                               value="{{ old('std_lama_proses', $stdFan->std_lama_proses) }}" placeholder="Masukkan std lama proses" required>
                                                        <div class="input-group-append">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="fan_3" class="form-control @error('fan_3') is-invalid @enderror" 
                                                               value="{{ old('fan_3', $stdFan->fan_3) }}" placeholder="Masukkan std fan 3">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">%</span>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="fan_4" class="form-control @error('fan_4') is-invalid @enderror" 
                                                               value="{{ old('fan_4', $stdFan->fan_4) }}" placeholder="Masukkan std fan 4">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">%</span>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="std_humadity" class="form-control @error('std_humadity') is-invalid @enderror" 
                                                               value="{{ old('std_humadity', $stdFan->std_humadity) }}" placeholder="Masukkan std humidity/steam valve">
                                                        <div class="input-group-append">
                                                            <span class="input-group-text">%</span>
                                                        </div>
