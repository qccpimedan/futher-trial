...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edit Data Suhu Pemasakan</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title"> Form Edit Suhu Pemasakan</h3>
                        </div>
                        <div class="card-body">
                            @if ($errors->any())
                            ...
                            <form action="{{ route('suhu-blok.update', $suhuBlok->uuid) }}" method="POST">
                                @csrf
                                @method('PUT')
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_plan" class="form-control form-control-border select2" required>
                                                        <option value="">Pilih Plan</option>
                                                        @foreach($plans as $plan)
                                                            <option value="{{ $plan->id }}" {{ $suhuBlok->id_plan == $plan->id ? 'selected' : '' }}>
                                                                {{ $plan->nama_plan }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="id_produk" class="form-control form-control-border select2" required>
                                                        <option value="">Pilih Produk</option>
                                                        @foreach($products as $product)
                                                            <option value="{{ $product->id }}" {{ $suhuBlok->id_produk == $product->id ? 'selected' : '' }}>
                                                                {{ $product->nama_produk }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="suhu_blok" class="form-control form-control-border" 
                                                               value="{{ old('suhu_blok', $suhuBlok->suhu_blok) }}" placeholder="Masukkan suhu blok" required>
