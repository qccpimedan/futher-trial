{{-- filepath: resources/views/super-admin/data_shift/create.blade.php --}}
@extends('layouts.app')
@section('container')
                ...
                <div class="col-md-12">
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            <h3 class="card-title">Form Tambah Data Shift</h3>
                        </div>
                        <form action="{{ route('data-shift.store') }}" method="POST">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="shift" id="shift" class="form-control" placeholder="Masukkan Shift" required>
                                </div>
                            </div>
