...
@section('title', 'Riwayat Perubahan Data - Pemeriksaan Rheon Machine')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('pemeriksaan-rheon-machine.index') }}">Pemeriksaan Rheon Machine</a></li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <span class="badge badge-primary">{{ $item->batch ?? 'N/A' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($log->field_yang_diubah && count($log->field_yang_diubah) > 0)
                                                        @php
                                                            $fieldNames = \App\Models\PemeriksaanRheonMachineLog::getFieldNames();
                                                        @endphp
