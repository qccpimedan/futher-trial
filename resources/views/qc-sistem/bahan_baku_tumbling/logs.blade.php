...
@section('title', 'Riwayat Perubahan Data - Bahan Baku Tumbling')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <span class="badge badge-info">{{ $bahanBakuTumbling->kode_produksi ?? '-' }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Nama Bahan Baku:</strong><br>
                                    <span class="badge badge-secondary">{{ $bahanBakuTumbling->nama_bahan_baku ?? '-' }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Tanggal:</strong><br>
                                    <span class="badge badge-secondary">{{ $bahanBakuTumbling->tanggal ? $bahanBakuTumbling->tanggal->format('d/m/Y') : '-' }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Shift:</strong><br>
                                    <span class="badge badge-primary">{{ $bahanBakuTumbling->shift->shift ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('bahan-baku-tumbling.index') }}" class="btn btn-secondary btn-sm">
