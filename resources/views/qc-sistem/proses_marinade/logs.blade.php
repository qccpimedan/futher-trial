...
@section('title', 'Riwayat Perubahan Data - Proses Marinade')
                ...
                <div class="col-12">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <strong>Jenis Marinade:</strong><br>
                                    <span class="badge badge-info">{{ $prosesMarinadeModel->jenisMarinade->jenis_marinade ?? '-' }}</span>
                                </div>
                                <div class="col-md-4">
                                    <strong>Kode Produksi:</strong><br>
                                    <span class="badge badge-secondary">{{ $prosesMarinadeModel->kode_produksi ?? '-' }}</span>
                                </div>
                                <div class="col-md-4">
                                    <strong>Shift:</strong><br>
                                    <span class="badge badge-primary">{{ $prosesMarinadeModel->shift->shift ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('proses-marinade.index') }}" class="btn btn-secondary btn-sm">
