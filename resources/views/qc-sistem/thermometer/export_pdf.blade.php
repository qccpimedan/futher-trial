...
<head>
    <meta charset="utf-8">
    <title>Verifikasi Proses Produksi - Data Thermometer</title>
    <style>
        body {
...
<body>
    ...
    <div class="title">PEMERIKSAAN THERMOMETER</div>
        ...
        <table class="main-table">
            <thead>
                <tr>
                    ...
                    <th style="width: 20%;">Kode Thermometer</th>
                    <th style="width: 10%;">Hasil Verifikasi 0&deg;C</th>
                    <th style="width: 10%;">Hasil Verifikasi 100&deg;C</th>
                    <th style="width: 20%;">Hasil Pengecekan</th>
                </tr>
            </thead>
            <tbody>
                @foreach($data as $index => $item)
                    <tr>
                        ...
                        <td>
                            @if($item->hasil_pengecekan === 'ok')
                                <span style="color: #000; font-weight: bold;">OK</span>
                            @else
                                <span class="status-tidak-ok">Tidak OK</span>
                            @endif
                        </td>
                    </tr>
                @endforeach
