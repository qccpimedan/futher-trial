...
@section('title', 'Detail Data Thermometer')
...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Detail Data Thermometer</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
@if(auth()->user()->hasPermissionTo('edit-thermometer'))
                            <a href="{{ route('thermometer.edit', $data->uuid) }}" class="btn btn-warning btn-sm">
                                <i class="fas fa-edit"></i> Edit Data
                            </a>
                            @endif
<a href="{{ route('thermometer.index') }}" class="btn btn-secondary btn-sm">
                                ...
                                <div class="card card-outline card-info">
                                    ...
                                    <div class="card-body">
                                        <table class="table table-borderless">
                                            ...
                                            <tr>
                                                <td><strong><i class="fas fa-clock"></i> Jam:</strong></td>
                                                <td>
                                                    <span class="badge badge-secondary">
                                                        {{ $data->jam ? \Carbon\Carbon::parse($data->jam)->format('H:i') : '-' }}
                                                    </span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td><strong><i class="fas fa-tag"></i> Jenis:</strong></td>
                                                <td>{{ $data->jenis }}</td>
                                            </tr>
                                            <tr>
                                                <td><strong><i class="fas fa-barcode"></i> Kode Thermometer:</strong></td>
                                                <td>
                                                    <span class="badge badge-secondary">
                                                        {{ $data->kode_thermometer }}
                                                    </span>
                                                </td>
                                            </tr>
                                        </table>
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-3">
                                            <div class="col-6 text-center">
                                                ...
                                                <div class="display-4">
                                                    <span class="badge {{ $data->hasil_pengecekan === 'ok' ? 'badge-success' : 'badge-danger' }}" style="font-size: 1.2rem;">
                                            ...
                                            <div class="col-6 text-center">
                                                ...
                                                <div>
                                                    <div class="mb-2">
                                                        <span class="badge badge-info" style="font-size: 1rem;">0&deg;C: {{ $data->hasil_verifikasi_0 ?? '-' }}</span>
                                                    </div>
                                                    <div>
                                                        <span class="badge badge-info" style="font-size: 1rem;">100&deg;C: {{ $data->hasil_verifikasi_100 ?? '-' }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="card-footer">
                        <div class="row">
                            <div class="col-md-6">
@if(auth()->user()->hasPermissionTo('edit-thermometer'))
                                <a href="{{ route('thermometer.edit', $data->uuid) }}" class="btn btn-warning">
                                    <i class="fas fa-edit"></i> Edit Data
                                </a>
                                @endif
...
@if(auth()->user()->hasPermissionTo('delete-thermometer'))
                                <form action="{{ route('thermometer.destroy', $data->uuid) }}" 
                                      method="POST" 
