...
@section('title', 'Riwayat Perubahan Data - Thermometer')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('thermometer.index') }}">Thermometer</a></li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <span class="badge badge-info">{{ $item->jenis ?? 'N/A' }}</span>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <strong>Kode Thermometer:</strong><br>
                                    <span class="badge badge-warning">{{ $item->kode_thermometer ?? 'N/A' }}</span>
                                </div>
                            </div>
                            <!-- <div class="row mt-2">
                                <div class="col-md-6">
                                    <strong>Hasil Pengecekan:</strong><br>
                                    <span class="badge {{ $item->hasil_pengecekan === 'ok' ? 'badge-success' : 'badge-danger' }}">
                                        {{ $item->hasil_pengecekan_label ?? 'N/A' }}
                                    </span>
                                </div>
                            </div> -->
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($log->field_yang_diubah && count($log->field_yang_diubah) > 0)
                                                        @php
                                                            $fieldNames = \App\Models\ThermometerLog::getFieldNames();
                                                        @endphp
                                                            ...
                                                            @foreach($log->field_yang_diubah as $field)
                                                                @php
                                                                    ...
                                                                    if ($field === 'hasil_pengecekan') {
                                                                        $hasilOptions = \App\Models\Thermometer::getHasilPengecekanOptions();
