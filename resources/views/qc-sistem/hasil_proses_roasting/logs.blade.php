...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-history text-warning"></i> Log Perubahan Hasil Proses Roasting</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <span class="badge badge-secondary">{{ $hasilProsesRoasting->produk->nama_produk ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-4">
                            <strong>Shift:</strong><br>
                            <span class="badge badge-primary">Shift {{ $hasilProsesRoasting->shift->shift ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-4">
                            <strong>Tanggal:</strong><br>
                            <span class="badge badge-success">{{ $hasilProsesRoasting->tanggal ? \Carbon\Carbon::parse($hasilProsesRoasting->tanggal)->format('d-m-Y H:i:s') : 'N/A' }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('hasil-proses-roasting.index') }}" class="btn btn-sm btn-secondary">
                                        ...
                                        <td>
                                            <div class="change-details">
                                                @if($log->nilai_lama && $log->nilai_baru)
                                                    @foreach($log->field_yang_diubah as $idx => $field)
                                                        @php
                                                            $nilaiLama = $log->nilai_lama[$idx] ?? 'Kosong';
                                                            $nilaiBaru = $log->nilai_baru[$idx] ?? 'Kosong';
