...
@section('title', 'Riwayat Perubahan Data - Pemeriksaan Produk Cooking Mixer FLA')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('pemeriksaan-produk-cooking-mixer-fla.index') }}">Pemeriksaan Produk Cooking Mixer FLA</a></li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <span class="badge badge-info">{{ $item->namaFormulaFla->produk->nama_produk ?? 'N/A' }}</span>
                                </div>
                                <div class="col-md-4">
                                    <strong>Tanggal:</strong><br>
                                    <span class="badge badge-secondary">{{ $item->tanggal ? \Carbon\Carbon::parse($item->tanggal)->format('d/m/Y H:i') : 'N/A' }}</span>
                                </div>
                                <div class="col-md-4">
                                    <strong>Kode Produksi:</strong><br>
                                    <span class="badge badge-primary">{{ $item->kode_produksi ?? 'N/A' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('pemeriksaan-produk-cooking-mixer-fla.index') }}" class="btn btn-secondary btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($log->field_yang_diubah && count($log->field_yang_diubah) > 0)
                                                        @php
                                                            $fieldNames = \App\Models\PemeriksaanProdukCookingMixerFlaLog::getFieldNames();
                                                        @endphp
