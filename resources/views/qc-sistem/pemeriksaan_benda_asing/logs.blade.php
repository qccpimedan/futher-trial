...
@section('title', 'Riwayat Perubahan Data - Pemeriksaan Benda Asing')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <span class="badge badge-info">{{ $item->produk->nama_produk ?? 'N/A' }}</span>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <strong>Jenis Kontaminasi:</strong><br>
                                    <span class="badge badge-warning">{{ $item->jenis_kontaminasi ?? 'N/A' }}</span>
                                </div>
                            </div>
                            <!-- <div class="row mt-2">
                                <div class="col-md-6">
                                    <strong>Kode Produksi:</strong><br>
                                    <span class="badge badge-success">{{ $item->kode_produksi ?? 'N/A' }}</span>
                                </div>
                                <div class="col-md-6">
                                    <strong>Ukuran Kontaminasi:</strong><br>
                                    <span class="badge badge-danger">{{ $item->ukuran_kontaminasi ?? 'N/A' }}</span>
                                </div>
                            </div> -->
                        </div>
                    </div>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('pemeriksaan-benda-asing.index') }}" class="btn btn-secondary btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($log->field_yang_diubah && count($log->field_yang_diubah) > 0)
                                                        @php
                                                            $fieldNames = \App\Models\PemeriksaanBendaAsingLog::getFieldNames();
                                                        @endphp
