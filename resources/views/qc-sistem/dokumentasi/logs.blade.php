...
@section('title', 'Riwayat Perubahan Data - Dokumentasi')
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <span class="badge badge-info">{{ $item->pengemasanproduk->kode_produksi ?? 'N/A' }}</span>
                                </div>
                                <div class="col-md-4">
                                    <strong>Plan:</strong><br>
                                    <span class="badge badge-primary">{{ $item->plan->nama_plan ?? 'N/A' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($log->field_yang_diubah && count($log->field_yang_diubah) > 0)
                                                        @php
                                                            $fieldNames = \App\Models\DokumentasiLog::getFieldNames();
                                                        @endphp
