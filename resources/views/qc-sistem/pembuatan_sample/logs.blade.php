...
@section('title', 'Riwayat Perubahan Data - Pembuatan Sample')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('pembuatan-sample.index') }}">Pembuatan Sample</a></li>
                ...
                <div class="col-12">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <strong>Nama Sample:</strong><br>
                                    <span class="badge badge-info">{{ $item->nama_sample ?? 'N/A' }}</span>
                                </div>
                                <div class="col-md-4">
                                    <strong>Tanggal:</strong><br>
                                    <span class="badge badge-secondary">{{ $item->tanggal ? $item->tanggal->format('d/m/Y H:i') : 'N/A' }}</span>
                                </div>
                                <div class="col-md-4">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('pembuatan-sample.index') }}" class="btn btn-secondary btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($log->field_yang_diubah && count($log->field_yang_diubah) > 0)
                                                        @php
                                                            $fieldNames = \App\Models\PembuatanSampleLog::getFieldNames();
                                                        @endphp
