...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-history text-warning"></i> Log Perubahan Pembuatan Predust</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <span class="badge badge-info">{{ $pembuatanPredust->produk->nama_produk ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-3">
                            <strong>Kode Produksi:</strong><br>
                            <span class="badge badge-secondary">{{ $pembuatanPredust->kode_produksi ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-3">
                            <strong>Jenis Predust:</strong><br>
                            <span class="badge badge-primary">{{ $pembuatanPredust->jenisPredust->nama_predust ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-3">
                            <strong>Tanggal:</strong><br>
                            <span class="badge badge-success">{{ $pembuatanPredust->tanggal ? $pembuatanPredust->tanggal->format('d-m-Y H:i:s') : 'N/A' }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('pembuatan-predust.index') }}" class="btn btn-sm btn-secondary">
