...
@section('title', 'Riwayat Perubahan Data - Timbangan')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('timbangan.index') }}">Timbangan</a></li>
                    ...
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <strong>Kode Timbangan:</strong><br>
                                    <span class="badge badge-warning">{{ $item->kode_timbangan ?? 'N/A' }}</span>
                                </div>
                            </div>
                            <!-- <div class="row mt-2">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <span class="badge badge-info">{{ $item->gram_label ?? 'N/A' }}</span>
                                </div>
                            </div> -->
                        </div>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($log->field_yang_diubah && count($log->field_yang_diubah) > 0)
                                                        @php
                                                            $fieldNames = \App\Models\TimbanganLog::getFieldNames();
                                                        @endphp
                                                            ...
                                                            @foreach($log->field_yang_diubah as $field)
                                                                @php
                                                                    ...
                                                                    if ($field === 'hasil_pengecekan') {
                                                                        $hasilOptions = \App\Models\Timbangan::getHasilPengecekanOptions();
