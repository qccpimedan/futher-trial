...
@section('title', 'Riwayat Perubahan Data - Verifikasi Berat Produk')
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <span class="badge badge-secondary">{{ $item->tanggal ?? 'N/A' }}</span>
                                </div>
                                <div class="col-md-4">
                                    <strong>Shift:</strong><br>
                                    <span class="badge badge-primary">{{ $item->shift_id ?? 'N/A' }}</span>
                                </div>
                                <!-- <div class="col-md-3">
                                    <strong>Status Verifikasi:</strong><br>
                                    <span class="badge badge-success">{{ $item->status_verifikasi ?? 'N/A' }}</span>
                                </div> -->
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($log->field_yang_diubah && count($log->field_yang_diubah) > 0)
                                                        @php
                                                            $fieldNames = \App\Models\VerifikasiBeratLog::getFieldNames();
                                                        @endphp
                                                        ...
                                                        @if($log->nilai_lama && $log->nilai_baru)
                                                            ...
                                                            @foreach($log->field_yang_diubah as $field)
                                                                ...
                                                                <div class="mb-1">
                                                                    ...
                                                                    <span class="text-danger">{{ is_array($nilaiLama) ? json_encode($nilaiLama) : $nilaiLama }}</span>
                                                                    <i class="fas fa-arrow-right text-muted"></i>
                                                                    <span class="text-success">{{ is_array($nilaiBaru) ? json_encode($nilaiBaru) : $nilaiBaru }}</span>
                                                                </div>
                                                            @endforeach
                                                        @endif
                                                    </div>
