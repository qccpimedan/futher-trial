                    ...
                    <div class="col-12">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="form-label">Gramase <span class="text-danger">*</span></label>
                                    <select id="nilai_select_berat" class="form-control @error('gramase') is-invalid @enderror" name="gramase" data-selected="{{ old('gramase') }}" required></select>
                                    @error('gramase')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="jenis_produk_kfc" id="jenis_produk_kfc" class="form-control @error('jenis_produk_kfc') is-invalid @enderror" required>
                                        ...
                                        <option value="KFC" {{ old('jenis_produk_kfc') == 'KFC' ? 'selected' : '' }}>Produk Yum!</option>
                                        <option value="non-KFC" {{ old('jenis_produk_kfc') == 'non-KFC' ? 'selected' : '' }}>Non Yum!</option>
                                    </select>
                                ...
                                <div class="card card-info">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div id="regular-after-forming-fields">
                                            ...
                                            <div class="text-center mb-3">
                                                <button type="button" class="btn btn-success add-after-forming">
                                                    <i class="fas fa-plus"></i> Tambah Data Berat Sebelum Pemasakan
                                                </button>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="rata_rata_after_forming">Rata-rata  Berat Sebelum Pemasakan</label>
                                                        <input type="number" step="0.01" name="rata_rata_after_forming" id="rata_rata_after_forming" class="form-control" readonly>
                                                        <small class="text-muted">Otomatis dihitung dari data Berat Sebelum Pemasakan</small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-3" id="pickup-after-forming-kfc-field">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="pickup_after_forming_kfc">Pickup After Forming Produk Yum!</label>
                                                    <input type="number" step="0.01" name="pickup_after_forming_kfc" id="pickup_after_forming_kfc" class="form-control" readonly>
                                                    <small class="text-muted">
                                                        <strong>Rumus Pickup After Forming Produk Yum!:</strong><br>
                                ...
                                <div class="card card-primary">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-6">
                                                <button type="button" class="btn btn-primary btn-block" id="btn-ke-roasting" style="display: none;">
                                                    <i class="fas fa-arrow-right"></i> Ke Roasting
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <!-- Roasting Section (Initially Hidden) -->
                        <div class="row mt-4" id="roasting-section" style="display: none;">
                            <div class="col-12">
                                <div class="card card-primary">
                                    <div class="card-header">
                                        <h3 class="card-title">Berat Roasting</h3>
                                    </div>
                                    <div class="card-body">
                                        <div id="roasting-container">
                                            <div class="roasting-entry mb-3">
                                                <div class="input-group">
                                                    <input type="number" step="0.01" name="berat_roasting[]" class="form-control roasting-input" placeholder="Masukkan berat roasting">
                                                    <div class="input-group-append">
                                                        <button type="button" class="btn btn-danger remove-roasting" style="display: none;">
                                                            <i class="fas fa-minus"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="text-center mb-3">
                                            <button type="button" class="btn btn-success add-roasting">
                                                <i class="fas fa-plus"></i> Tambah Berat Roasting
                                            </button>
                                        </div>

                                        <!-- Rata-rata Roasting + Pickup -->
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="rata_rata_roasting">Rata-rata Roasting</label>
                                                    <input type="number" step="0.01" name="rata_rata_roasting" id="rata_rata_roasting" class="form-control" readonly>
                                                    <small class="text-muted">Otomatis dihitung dari berat roasting</small>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="pickup_after_breadering_roasting" id="pickup-roasting-label">Pickup After Breadering-Roasting</label>
                                                    <input type="number" step="0.01" name="pickup_after_breadering_roasting" id="pickup_after_breadering_roasting" class="form-control" readonly>
                                                    <small class="text-muted">
                                                        <strong id="pickup-roasting-formula-title">Rumus Pickup After Breadering-Roasting:</strong><br>
                                                        <span id="pickup-roasting-formula">(Rata-rata Roasting - Rata-rata Breadering) / Rata-rata Breadering × 100</span>
                                                    </small>
                                                </div>
                                            </div>
                                        </div>

                                        <!-- Hitung Pick Up Total Roasting -->
                                        <div class="row mt-3" id="pickup-total-roasting-section">
                                            <div class="col-md-6">
                                                <button type="button" class="btn btn-info btn-sm btn-block" id="btn-hitung-pickup-total-roasting">
                                                    <i class="fas fa-calculator"></i> Hitung Pick Up Total
                                                </button>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group" id="pickup-total-roasting-field" style="display: none;">
                                                    <label for="pickup_total_roasting">Pick Up Total Roasting</label>
                                                    <input type="number" step="0.01" name="pickup_total_roasting" id="pickup_total_roasting" class="form-control" readonly>
                                                    <small class="text-muted">
                                                        <strong>Rumus Pick Up Total Roasting:</strong><br>
                                                        (Rata-rata Roasting - Rata-rata After Forming) / Rata-rata Roasting × 100
                                                    </small>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card card-danger">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mt-3" id="fryer-1-buttons-non-kfc">
                                            ...
                                            <div class="col-md-4">
                                                <button type="button" class="btn btn-primary btn-sm btn-block" id="btn-fryer-1-ke-roasting">
                                                    <i class="fas fa-arrow-right"></i> Ke Roasting
                                                </button>
                                            </div>
                                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Hitung Pick Up Total Roasting Button Click
    $(document).on('click', '#btn-hitung-pickup-total-roasting', function() {
        $('#pickup-total-roasting-field').slideDown();
        calculatePickupTotalRoasting();
        $(this)
            .prop('disabled', true)
            .removeClass('btn-info')
            .addClass('btn-secondary')
            .text('Pick Up Total Aktif');
    });

    function calculatePickupTotalRoasting() {
        const rataRataRoasting = parseFloat($('#rata_rata_roasting').val());
        const rataRataAfterForming = parseFloat($('#rata_rata_after_forming').val());

        if (!isNaN(rataRataRoasting) && !isNaN(rataRataAfterForming) && rataRataRoasting > 0) {
            const pickup = ((rataRataRoasting - rataRataAfterForming) / rataRataRoasting * 100).toFixed(2);
            $('#pickup_total_roasting').val(pickup);
        } else {
            $('#pickup_total_roasting').val('');
        }
    }
    ...
    function calculateAfterFormingAverage() {
        ...
        // Recalculate pickup total roasting if it's active
        if ($('#pickup-total-roasting-field').is(':visible')) {
            calculatePickupTotalRoasting();
        }
    ...
    function resetToNonKFCWorkflow() {
        ...
        window.roastingPickupBase = 'breadering';

        $('#btn-ke-roasting')
            .prop('disabled', false)
            .removeClass('btn-secondary')
            .addClass('btn-primary')
            .html('<i class="fas fa-arrow-right"></i> Ke Roasting');

        $('#btn-ke-fryer-1')
            .prop('disabled', false)
            .removeClass('btn-secondary')
            .addClass('btn-danger')
            .html('<i class="fas fa-arrow-right"></i> Ke Fryer 1');

        $('#roasting-section').hide();
        $('#roasting-container').html(`
            <div class="roasting-entry mb-3">
                <div class="input-group">
                    <input type="number" step="0.01" name="berat_roasting[]" class="form-control roasting-input" placeholder="Masukkan berat roasting">
                    <div class="input-group-append">
        ...
        `);
        $('#rata_rata_roasting').val('');
        $('#pickup_after_breadering_roasting').val('');
        $('#pickup_total_roasting').val('');
        $('#pickup-total-roasting-field').hide();
        $('#btn-hitung-pickup-total-roasting').prop('disabled', false).removeClass('btn-secondary').addClass('btn-info').html('<i class="fas fa-calculator"></i> Hitung Pick Up Total');

        $('#btn-fryer-1-ke-roasting')
            .prop('disabled', false)
            .removeClass('btn-secondary')
            .addClass('btn-primary')
            .html('<i class="fas fa-arrow-right"></i> Ke Roasting');
        ...
        $('#btn-hitung-pickup-total').prop('disabled', false).removeClass('btn-secondary').addClass('btn-info').html('<i class="fas fa-calculator"></i> Hitung Pick Up Total');
        $('#btn-ke-fryer-2').prop('disabled', false).removeClass('btn-secondary').addClass('btn-warning').html('<i class="fas fa-arrow-right"></i> Ke Fryer 2');
    ...
    // Show Roasting Section (non-KFC)
    $(document).on('click', '#btn-ke-roasting', function() {
        window.roastingPickupBase = 'breadering';
        $(this)
            .prop('disabled', true)
            .removeClass('btn-primary')
            .addClass('btn-secondary')
            .html('<i class="fas fa-check"></i> Roasting Aktif');

        $('#roasting-section').slideDown();
        $('#btn-ke-fryer-1')
            .prop('disabled', true)
            .removeClass('btn-danger')
            .addClass('btn-secondary')
            .text('Fryer 1 (Roasting Aktif)');
        $('html, body').animate({
            scrollTop: $('#roasting-section').offset().top - 100
        }, 800);
    });

    // Show Roasting Section from Fryer 1 (non-KFC)
    $(document).on('click', '#btn-fryer-1-ke-roasting', function() {
        window.roastingPickupBase = 'fryer_1';
        $(this)
            .prop('disabled', true)
            .removeClass('btn-primary')
            .addClass('btn-secondary')
        ...
        $('#btn-ke-fryer-2')
            ...
            .addClass('btn-secondary')
            .text('Fryer 2 (Roasting Aktif)');

        $('#btn-hitung-pickup-total')
            .prop('disabled', true)
            .removeClass('btn-info')
            .addClass('btn-secondary')
            .text('Pick Up Total (Roasting Aktif)');
        ...
        $('#roasting-section').slideDown();
        calculateRoastingAverage();
        calculatePickupAfterBreaderingRoasting();
    ...
    // Add Roasting Entry
    $(document).on('click', '.add-roasting', function() {
        const container = $('#roasting-container');
        const newEntry = `
            <div class="roasting-entry mb-3">
                <div class="input-group">
                    <input type="number" step="0.01" name="berat_roasting[]" class="form-control roasting-input" placeholder="Masukkan berat roasting">
                    <div class="input-group-append">
                        <button type="button" class="btn btn-danger remove-roasting">
                            <i class="fas fa-minus"></i>
                        </button>
                    </div>
                </div>
        ...
        `;
        container.append(newEntry);
        updateRoastingRemoveButtons();
        calculateRoastingAverage();
    });

    // Remove Roasting Entry
    $(document).on('click', '.remove-roasting', function() {
        $(this).closest('.roasting-entry').remove();
        updateRoastingRemoveButtons();
        calculateRoastingAverage();
    });

    // Calculate roasting average when input changes
    $(document).on('input', '.roasting-input', function() {
        calculateRoastingAverage();
    });

    function updateRoastingRemoveButtons() {
        const entries = $('.roasting-entry');
        if (entries.length <= 1) {
            $('.remove-roasting').hide();
        } else {
            $('.remove-roasting').show();
        }
    }

    function calculateRoastingAverage() {
        const inputs = $('.roasting-input');
        let total = 0;
        let count = 0;
        ...
        const average = count > 0 ? (total / count).toFixed(2) : '';
        $('#rata_rata_roasting').val(average);
        calculatePickupAfterBreaderingRoasting();
    ...
    function calculatePickupAfterBreaderingRoasting() {
        const rataRataRoasting = parseFloat($('#rata_rata_roasting').val());
        const baseMode = window.roastingPickupBase || 'breadering';

        let baseValue = NaN;
        if (baseMode === 'fryer_1') {
            $('#pickup-roasting-label').text('Pickup After Fryer 1-Roasting');
            $('#pickup-roasting-formula-title').text('Rumus Pickup After Fryer 1-Roasting:');
            $('#pickup-roasting-formula').text('(Rata-rata Roasting - Rata-rata Fryer 1) / Rata-rata Fryer 1 × 100');
            baseValue = parseFloat($('#rata_rata_fryer_1').val());
        } else {
            $('#pickup-roasting-label').text('Pickup After Breadering-Roasting');
            $('#pickup-roasting-formula-title').text('Rumus Pickup After Breadering-Roasting:');
            $('#pickup-roasting-formula').text('(Rata-rata Roasting - Rata-rata Breadering) / Rata-rata Breadering × 100');
            baseValue = parseFloat($('#rata_rata_breadering').val());
        }

        if (!isNaN(rataRataRoasting) && !isNaN(baseValue) && baseValue > 0) {
            const pickup = ((rataRataRoasting - baseValue) / baseValue * 100).toFixed(2);
            $('#pickup_after_breadering_roasting').val(pickup);
        } else {
            $('#pickup_after_breadering_roasting').val('');
        }
    }
    ...
    $(document).on('click', '#btn-breader-ke-fryer-1', function() {
        ...
        $('#fryer-1-section').slideDown();
        $(this).prop('disabled', true).text('Fryer 1 Aktif (Produk Yum!)');
    ...
    $(document).on('click', '#btn-breader-ke-after-forming', function() {
        ...
        $('#after-forming-section').slideDown();
        $(this).prop('disabled', true).text('After Forming Aktif (Produk Yum!)');
    ...
    function updateFryer1ForKFCWorkflow() {
        ...
        $('#fryer-1-section .card-header h3').text('Berat Fryer 1 (Produk Yum!)');
    ...
    function updateAfterFormingForKFCWorkflow() {
        ...
        $('#after-forming-section .card-header h3').text('After Forming (Produk Yum!)');
        ...
        $('#btn-ke-predusting').text('Ke Predusting (Produk Yum!)');
