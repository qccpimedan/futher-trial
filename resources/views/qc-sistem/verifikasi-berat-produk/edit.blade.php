                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="gramase">Gramase</label>
                                    <select id="nilai_select_berat" class="form-control @error('gramase') is-invalid @enderror" name="gramase" data-selected="{{ old('gramase', $verifikasiBeratProduk->gramase) }}" required></select>
                                    @error('gramase')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="catatan" id="catatan" rows="3" class="form-control @error('catatan') is-invalid @enderror">{{ old('catatan') ?? $verifikasiBeratProduk->catatan }}</textarea>
                                    @error('catatan')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <meta name="current-roasting-data" content="{{ json_encode($verifikasiBeratProduk->berat_roasting ?? []) }}">
                        ...
                        @if($verifikasiBeratProduk->jenis_produk_kfc === 'non-KFC')
                            <!-- Roasting Section -->
                            <div class="card mt-3" id="roasting-section">
                                <div class="card-header bg-primary text-white">
                                    <h3 class="card-title mb-0">Berat Roasting</h3>
                                </div>
                                <div class="card-body">
                                    <div id="roasting-container">
                                        @if($verifikasiBeratProduk->berat_roasting)
                                            @foreach($verifikasiBeratProduk->berat_roasting as $index => $berat)
                                                <div class="roasting-entry mb-3">
                                                    <div class="input-group">
                                                        <input type="number" step="0.01" name="berat_roasting[]" class="form-control roasting-input" placeholder="Masukkan berat roasting" value="{{ $berat }}">
                                                        <div class="input-group-append">
                                                            <button type="button" class="btn btn-danger remove-roasting" {{ $index === 0 ? 'style=display:none;' : '' }}>
                                                                <i class="fas fa-minus"></i>
                                                            </button>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="0.01" name="rata_rata_roasting" id="rata_rata_roasting" class="form-control" value="{{ $verifikasiBeratProduk->rata_rata_roasting }}" readonly>
                                                <small class="text-muted">Otomatis dihitung dari berat roasting</small>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="pickup_after_breadering_roasting">Pickup After Breadering/Fryer 1 - Roasting</label>
                                                <input type="number" step="0.01" name="pickup_after_breadering_roasting" id="pickup_after_breadering_roasting" class="form-control" value="{{ $verifikasiBeratProduk->pickup_after_breadering_roasting }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="0.01" name="pickup_total_roasting" id="pickup_total_roasting" class="form-control" value="{{ $verifikasiBeratProduk->pickup_total_roasting }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
$(document).ready(function() {
    ...
    $(document).on('click', '.add-roasting', function() {
        ...
        container.append(newEntry);
        updateRemoveButtons('.roasting-entry', '.remove-roasting');
    ...
    function calculateRoastingAverage() {
        const values = $('.roasting-input').map(function() {
            return parseFloat($(this).val()) || 0;
        }).get().filter(val => val > 0);
    ...
    function calculatePickupAfterBreaderingRoasting() {
        const rataRataRoasting = parseFloat($('#rata_rata_roasting').val()) || 0;
        ...
        const baseValue = parseFloat($('#rata_rata_breadering').val()) || 0;

        if (rataRataRoasting > 0 && baseValue > 0) {
    ...
    function calculatePickupTotalRoasting() {
        ...
        if (rataRataRoasting > 0 && rataRataAfterForming > 0) {
    ...
    function triggerAllCalculations() {
        ...
        if ($('.roasting-input').length) calculateRoastingAverage();
    ...
    setTimeout(function() {
        ...
        $('.roasting-input').off('input change keyup').on('input change keyup', function() {
            calculateRoastingAverage();
            calculateAllPickups();
        });
