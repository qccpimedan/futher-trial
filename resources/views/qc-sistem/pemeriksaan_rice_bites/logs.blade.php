...
@section('title', 'Riwayat Perubahan Data - Pemeriksaan Rice Bites')
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('pemeriksaan-rice-bites.index') }}" class="btn btn-secondary btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($log->field_yang_diubah && count($log->field_yang_diubah) > 0)
                                                        @php
                                                            $fieldNames = \App\Models\PemeriksaanRiceBitesLog::getFieldNames();
                                                        @endphp
