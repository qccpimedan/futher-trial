{{-- filepath: resources/views/qc-sistem/frayer_4/edit.blade.php --}}
@extends('layouts.app')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-3">
                    <div class="col-sm-6">
                        <h1 class="m-0">Edit Data Frayer 4</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('frayer-4.index') }}">Frayer 4</a></li>
                    ...
                    <div class="col-12">
                        <div class="card card-warning">
                            <div class="card-header">
                                <h3 class="card-title">
                                    <i class="fas fa-edit"></i> Form Edit Frayer 4
                                </h3>
                            </div>
                            ...
                            <form class="form-horizontal mb-4" method="POST" action="{{ route('frayer-4.update', ['uuid' => $frayer4->uuid]) }}">
                                @csrf
                                @method('PUT')
                                            ...
                                            <div class="card card-primary card-outline">
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="tanggal" name="tanggal" value="{{ \Carbon\Carbon::parse($frayer4->tanggal)->format('d-m-Y H:i:s') }}" readonly>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="form-control" id="id_produk" name="id_produk" required>
                                                                ...
                                                                @foreach ($products as $product)
                                                                    <option value="{{ $product->id }}" {{ $frayer4->id_produk == $product->id ? 'selected' : '' }}>
                                                                        {{ $product->nama_produk }}
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                            ...
                                            <div class="card card-success card-outline">
                                                ...
                                                <div class="card-body">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="form-control" id="id_suhu_frayer" name="id_suhu_frayer" required>
                                                                ...
                                                                @foreach ($suhuFrayers as $suhu)
                                                                    <option value="{{ $suhu->id }}" {{ $frayer4->id_suhu_frayer == $suhu->id ? 'selected' : '' }}>
                                                                        {{ $suhu->suhu_frayer }}°C
                                                                    </option>
                                                                @endforeach
                                                            </select>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="aktual_suhu_penggorengan" name="aktual_suhu_penggorengan" value="{{ $frayer4->aktual_suhu_penggorengan }}" placeholder="Masukkan suhu aktual (°C)">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <select class="form-control" id="id_waktu_penggorengan" name="id_waktu_penggorengan" required>
                                                                ...
                                                                @foreach ($waktuPenggorengans as $waktu)
                                                                    <option value="{{ $waktu->id }}" {{ $frayer4->id_waktu_penggorengan == $waktu->id ? 'selected' : '' }}>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="aktual_penggorengan" name="aktual_penggorengan" value="{{ $frayer4->aktual_penggorengan }}" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" class="form-control" id="tpm_minyak" name="tpm_minyak" value="{{ $frayer4->tpm_minyak }}" required>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
