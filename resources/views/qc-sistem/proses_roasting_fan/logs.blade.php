...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-history text-warning"></i> Log Perubahan Proses Roasting Fan</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <span class="badge badge-info">{{ $prosesRoastingFan->plan->nama_plan ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-3">
                            <strong>Produk:</strong><br>
                            <span class="badge badge-secondary">{{ $prosesRoastingFan->produk->nama_produk ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-3">
                            <strong>Shift:</strong><br>
                            <span class="badge badge-primary">Shift {{ $prosesRoastingFan->shift->shift ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-3">
                            <strong>Tanggal:</strong><br>
                            <span class="badge badge-success">{{ $prosesRoastingFan->tanggal ? \Carbon\Carbon::parse($prosesRoastingFan->tanggal)->format('d-m-Y H:i:s') : 'N/A' }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('proses-roasting-fan.index') }}" class="btn btn-sm btn-secondary">
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-info">{{ $log->getUserName() ?? 'System' }}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <span class="text-primary">{{ $log->nama_field ?? 'Field tidak diketahui' }}</span>
                                        </td>
                                        <td>
                                            <div class="change-details">
                                                @if($log->nilai_lama && $log->nilai_baru && $log->field_yang_diubah)
                                                    @foreach($log->field_yang_diubah as $index => $field)
                                                        @php
                                                            ...
                                                            // Format using the model's method
                                                            $nilaiLama = $log->formatFieldValue($field, $nilaiLama);
                                                            $nilaiBaru = $log->formatFieldValue($field, $nilaiBaru);
                                                        @endphp
                                                        <div class="mb-1">
                                                    ...
                                                    @endforeach
                                                @else
                                                    <span class="text-muted">{{ $log->deskripsi_perubahan ?? 'Data perubahan tidak tersedia' }}</span>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
