...
@section('title', 'Tambah Data Produk Forming')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Tambah Data Produk Forming</h1>
                    </div>
                    <div class="col-sm-6">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form action="{{ route('produk-forming.store') }}" method="POST">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="id_produk">
                                            <i class="fas fa-box mr-1"></i>Produk Forming
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <select name="bahan_baku[0][penilaian]" class="form-control">
                                                ...
                                                @foreach(App\Models\ProdukForming::getBahanOptions() as $key => $value)
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                            <h3 class="card-title">
                                <i class="fas fa-box-open mr-2"></i>C. Kemasan
                            </h3>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="kemasan_plastik">Kemasan Plastik (1-6)</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="kemasan_karton">Kemasan Karton (1-6)</label>
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <textarea name="tindakan_koreksi" id="tindakan_koreksi" 
                                                  class="form-control @error('tindakan_koreksi') is-invalid @enderror" 
                                                  rows="3" placeholder="Masukkan tindakan koreksi jika diperlukan">{{ old('tindakan_koreksi') }}</textarea>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="verifikasi" id="verifikasi" class="form-control @error('verifikasi') is-invalid @enderror">
                                            ...
                                            @foreach(App\Models\ProdukForming::getVerifikasiOptions() as $key => $value)
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <a href="{{ route('produk-forming.index') }}" class="btn btn-secondary ml-2">
