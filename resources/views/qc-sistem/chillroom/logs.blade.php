...
@section('title', 'Riwayat Perubahan Data - Chillroom')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('chillroom.index') }}">Data Chillroom</a></li>
                ...
                <div class="col-12">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <strong>Nama RM:</strong><br>
                                    <span class="badge badge-info">{{ $item->nama_rm }}</span>
                                </div>
                                <div class="col-md-4">
                                    <strong>Tanggal:</strong><br>
                                    <span class="badge badge-secondary">{{ $item->tanggal }}</span>
                                </div>
                                <div class="col-md-4">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('chillroom.index') }}" class="btn btn-secondary btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($log->field_yang_diubah && count($log->field_yang_diubah) > 0)
                                                        @php
                                                            $fieldNames = \App\Models\ChillroomLog::getFieldNames();
                                                        @endphp
