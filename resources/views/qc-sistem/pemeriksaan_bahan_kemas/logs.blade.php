...
@section('title', 'Riwayat Perubahan Data - Pemeriksaan Bahan Kemas')
                ...
                <div class="col-12">
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <strong>Nama Kemasan:</strong><br>
                                    <span class="badge badge-info">{{ $item->nama_kemasan ?? '-' }}</span>
                                </div>
                                <div class="col-md-4">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('pemeriksaan-bahan-kemas.index') }}" class="btn btn-secondary btn-sm">
