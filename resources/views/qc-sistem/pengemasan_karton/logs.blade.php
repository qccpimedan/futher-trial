...
@section('title', 'Riwayat Perubahan Data - Pengemasan Karton')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <span class="badge badge-secondary">{{ \Carbon\Carbon::parse($pengemasanKarton->tanggal)->format('d/m/Y H:i') }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Plan:</strong><br>
                                    <span class="badge badge-info">{{ $pengemasanKarton->plan->nama_plan ?? '-' }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Shift:</strong><br>
                                    <span class="badge badge-primary">{{ $pengemasanKarton->shift->shift ?? '-' }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Produk:</strong><br>
                                    <span class="badge badge-success">{{ $pengemasanKarton->pengemasanProduk->produk->nama_produk ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('pengemasan-karton.index') }}" class="btn btn-secondary btn-sm">
                        ...
                        <div class="card-body">
                            @php
                                $logs = \App\Models\PengemasanKartonLog::where('pengemasan_karton_uuid', $pengemasanKarton->uuid)
                                    ->with('user')
