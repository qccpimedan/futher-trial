...
@section('title', 'Riwayat Perubahan Data - Ketidaksesuaian Benda Asing')
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <span class="badge badge-primary">{{ $item->tanggal->format('d/m/Y') }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Jenis Kontaminan:</strong><br>
                                    <span class="badge badge-warning">{{ $item->jenis_kontaminan }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('ketidaksesuaian-benda-asing.index') }}" class="btn btn-secondary btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($log->field_yang_diubah && count($log->field_yang_diubah) > 0)
                                                        @php
                                                            $fieldNames = \App\Models\KetidaksesuaianBendaAsingLog::getFieldNames();
                                                        @endphp
