...
@section('title', 'Riwayat Perubahan Data - Ketidaksesuaian Plastik')
                    ...
                    <div class="card card-info card-outline">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <!-- <div class="col-md-3">
                                    <strong>Kode Form:</strong><br>
                                    <span class="badge badge-success">{{ $item->kode_form ?? 'N/A' }}</span>
                                </div> -->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('ketidaksesuaian-plastik.index') }}" class="btn btn-secondary btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($log->field_yang_diubah && count($log->field_yang_diubah) > 0)
                                                        @php
                                                            $fieldNames = \App\Models\KetidaksesuaianPlastikLog::getFieldNames();
                                                        @endphp
