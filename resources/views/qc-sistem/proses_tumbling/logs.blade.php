...
@section('title', 'Riwayat Perubahan Data - Proses Tumbling')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <span class="badge badge-info">{{ $prosesTumbling->produk->nama_produk ?? '-' }}</span>
                                </div>
                                <div class="col-md-4">
                                    <strong>Kode Produksi:</strong><br>
                                    <span class="badge badge-secondary">{{ $prosesTumbling->kode_produksi ?? '-' }}</span>
                                </div>
                                <div class="col-md-4">
                                    <strong>Shift:</strong><br>
                                    <span class="badge badge-primary">{{ $prosesTumbling->shift->shift ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('proses-tumbling.index') }}" class="btn btn-secondary btn-sm">
