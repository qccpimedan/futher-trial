            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#roasting" data-toggle="tab">Roasting/Steaming</a></li>
                </ul>
              </div><!-- /.card-header -->
              <div class="card-body">
                <div class="tab-content">
                  <div class="active tab-pane" id="roasting">
                  <form action="{{ route('input-roasting.store') }}" method="POST">
                    @csrf 
                        <div class="row">
                            <div class="col-md-6">
