...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-history text-warning"></i> Log Perubahan Input Roasting</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <span class="badge badge-info">{{ $inputRoasting->plan->nama_plan ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-3">
                            <strong>Produk:</strong><br>
                            <span class="badge badge-secondary">{{ $inputRoasting->produk->nama_produk ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-3">
                            <strong>Shift:</strong><br>
                            <span class="badge badge-primary">Shift {{ $inputRoasting->shift->shift ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-3">
                            <strong>Tanggal:</strong><br>
                            <span class="badge badge-success">{{ $inputRoasting->tanggal ? \Carbon\Carbon::parse($inputRoasting->tanggal)->format('d-m-Y H:i:s') : 'N/A' }}</span>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-6">
                            <strong>Kode Produksi:</strong><br>
                            <span class="badge badge-warning">{{ $inputRoasting->kode_produksi }}</span>
                        </div>
                        <div class="col-md-6">
                            <strong>Waktu Pemasakan:</strong><br>
                            <span class="badge badge-dark">{{ $inputRoasting->waktu_pemasakan }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('input-roasting.index') }}" class="btn btn-sm btn-secondary">
                ...
                <div class="card-body">
                    @php
                        $logs = \App\Models\InputRoastingLog::with('user')
                            ->where('input_roasting_uuid', $inputRoasting->uuid)
