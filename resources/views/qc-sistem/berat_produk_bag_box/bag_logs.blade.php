...
@section('title', 'Riwayat Perubahan Data - Berat Produk Bag')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Riwayat Perubahan Bag</li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <span class="badge badge-secondary">{{ \Carbon\Carbon::parse($beratProdukBag->tanggal)->format('d/m/Y H:i') }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Plan:</strong><br>
                                    <span class="badge badge-info">{{ $beratProdukBag->plan->nama_plan ?? '-' }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Shift:</strong><br>
                                    <span class="badge badge-primary">{{ $beratProdukBag->shift->shift ?? '-' }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Line:</strong><br>
                                    <span class="badge badge-success">{{ $beratProdukBag->line }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            @php
                                $logs = \App\Models\BeratProdukBagLog::where('berat_produk_bag_uuid', $beratProdukBag->uuid)
                                    ->with('user')
