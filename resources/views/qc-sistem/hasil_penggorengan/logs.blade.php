...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-history text-warning"></i> Log Perubahan Hasil Penggorengan</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <span class="badge badge-info">{{ $hasilPenggorengan->produk->nama_produk ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-3">
                            <strong>Suhu Pusat:</strong><br>
                            <span class="badge badge-secondary">{{ $hasilPenggorengan->aktual_suhu_pusat }}°C</span>
                        </div>
                        <div class="col-md-3">
                            <strong>Shift:</strong><br>
                            <span class="badge badge-primary">Shift {{ $hasilPenggorengan->shift->shift ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-3">
                            <strong>Tanggal:</strong><br>
                            <span class="badge badge-success">{{ $hasilPenggorengan->tanggal ? \Carbon\Carbon::parse($hasilPenggorengan->tanggal)->format('d-m-Y H:i:s') : 'N/A' }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('hasil-penggorengan.index') }}" class="btn btn-sm btn-secondary">
                ...
                <div class="card-body">
                    @php
                        $logs = \App\Models\HasilPenggorenganLog::with('user')
                            ->where('hasil_penggorengan_uuid', $hasilPenggorengan->uuid)
