...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edit Data Kontrol Sanitasi</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                Form Edit Data Kontrol Sanitasi
                            </h3>
                        </div>
                        <form action="{{ route('kontrol-sanitasi.update', $kontrolSanitasi->uuid) }}" method="POST">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                @if($errors->any())
                                            ...
                                            <select class="form-control @error('shift_id') is-invalid @enderror" 
                                                ...
                                                @foreach($shifts as $shift)
                                                    <option value="{{ $shift->id }}" 
                                                            {{ (old('shift_id') ?? $kontrolSanitasi->shift_id) == $shift->id ? 'selected' : '' }}>
                                                        {{ $shift->shift }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="datetime-local" 
                                                   ...
                                                   id="tanggal" 
                                                   name="tanggal" 
                                                   value="{{ old('tanggal') ?? ($kontrolSanitasi->tanggal ? $kontrolSanitasi->tanggal->format('Y-m-d\TH:i') : '') }}" 
                                                   readonly>
                                            @error('tanggal')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   id="suhu_air" 
                                                   name="suhu_air" 
                                                   value="{{ old('suhu_air') ?? $kontrolSanitasi->suhu_air }}" 
                                                   min="0" 
                                                   max="100"
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            <label for="kadar_klorin_food_basin" class="font-weight-bold">Kadar Klorin Food Basin <span class="text-danger">*</span></label>
                                            <input type="text" 
                                                   ...
                                                   value="{{ old('kadar_klorin_food_basin') ?? $kontrolSanitasi->kadar_klorin_food_basin }}" 
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   value="{{ old('kadar_klorin_hand_basin') ?? $kontrolSanitasi->kadar_klorin_hand_basin }}" 
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea class="form-control @error('hasil_verifikasi') is-invalid @enderror" 
                                                      ...
                                                      required>{{ old('hasil_verifikasi') ?? $kontrolSanitasi->hasil_verifikasi }}</textarea>
                                ...
                                <div class="card-footer">
                                    <div class="">
                                        ...
                                        <a href="{{ route('kontrol-sanitasi.index') }}" class="btn btn-md btn-secondary">
