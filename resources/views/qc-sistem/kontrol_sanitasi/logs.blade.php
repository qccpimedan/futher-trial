...
@section('title', 'Riwayat Perubahan Data - Kontrol Sanitasi')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <span class="badge badge-info">{{ $item->tanggal->format('d/m/Y') }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Shift:</strong><br>
                                    <span class="badge badge-secondary">Shift {{ $item->shift->shift ?? 'N/A' }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Suhu Air:</strong><br>
                                    <span class="badge badge-primary">{{ $item->suhu_air }}°C</span>
                                </div>
                                <div class="col-md-3">
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('kontrol-sanitasi.index') }}" class="btn btn-secondary btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($log->field_yang_diubah && count($log->field_yang_diubah) > 0)
                                                        @php
                                                            $fieldNames = \App\Models\KontrolSanitasiLog::getFieldNames();
                                                        @endphp
