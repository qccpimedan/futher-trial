...
@section('title', 'Riwayat Perubahan Data - Pengemasan Produk')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <span class="badge badge-info">{{ $pengemasanProduk->kode_produksi ?? '-' }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Produk:</strong><br>
                                    <span class="badge badge-secondary">{{ $pengemasanProduk->produk->nama_produk ?? '-' }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Tanggal:</strong><br>
                                    <span class="badge badge-secondary">{{ $pengemasanProduk->tanggal ? $pengemasanProduk->tanggal->format('d/m/Y') : '-' }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Shift:</strong><br>
                                    <span class="badge badge-primary">{{ $pengemasanProduk->shift->shift ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('pengemasan-produk.index') }}" class="btn btn-secondary btn-sm">
