...
@section('title', 'Riwayat Perubahan Data - Pengemasan Plastik')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('pengemasan-plastik.index') }}">Pengemasan Plastik</a></li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <span class="badge badge-info">{{ $pengemasanPlastik->pengemasanProduk->produk->nama_produk ?? '-' }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Berat:</strong><br>
                                    <span class="badge badge-secondary">{{ $pengemasanPlastik->berat ?? '-' }} gram</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Tanggal:</strong><br>
                                    <span class="badge badge-secondary">{{ $pengemasanPlastik->tanggal ? $pengemasanPlastik->tanggal->format('d/m/Y') : '-' }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Shift:</strong><br>
                                    <span class="badge badge-primary">{{ $pengemasanPlastik->shift->shift ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('pengemasan-plastik.index') }}" class="btn btn-secondary btn-sm">
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span class="badge badge-info">{{ $log->user_role }}</span>
                                                </td>
                                                <td>
