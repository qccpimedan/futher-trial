...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-history text-warning"></i> Log Perubahan Proses Battering</h1>
                </div>
                <div class="col-sm-6">
            ...
            <div class="card card-info card-outline">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <strong>Jenis Better:</strong><br>
                            <span class="badge badge-secondary">{{ $item->jenis_better->nama_better ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <span class="badge badge-success">{{ $item->tanggal ? \Carbon\Carbon::parse($item->tanggal)->format('d-m-Y H:i:s') : 'N/A' }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('proses-battering.index') }}" class="btn btn-sm btn-secondary">
