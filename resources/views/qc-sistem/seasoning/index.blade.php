{{-- filepath: resources/views/qc-sistem/seasoning/index.blade.php --}}
@extends('layouts.app')
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-3">
                    <div class="col-sm-6">
                        <h1 class="m-0">Data Seasoning</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="">Dashboard</a></li>
                            <li class="breadcrumb-item active">Seasoning</li>
                        </ol>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-12">
                        <div class="card card-primary card-outline">
                            <div class="card-header">
                                <h3 class="card-title">
                                    Data Penyimpanan Bahan Seasoning
                                </h3>
                                <div class="card-tools">
                                    ...
                                    @if(auth()->user()->hasPermissionTo('create-seasoning'))
                                    <a href="{{ route('seasoning.create') }}" class="btn btn-primary btn-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3 mt-3">
                                    <div class="col-md-4 offset-md-8">
                                        <form action="{{ route('seasoning.index') }}" method="GET">
                                            <div class="input-group">
                                                ...
                                                <div class="input-group-append">
                                                    ...
                                                    @if(request('search'))
                                                        <a href="{{ route('seasoning.index') }}" class="btn btn-outline-danger" title="Clear Search">
                                ...
                                @include('qc-sistem.seasoning._table')
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="bulkExportForm" action="{{ route('seasoning.bulk-export-pdf') }}" method="POST" data-bulk-form="true">
                    @csrf
...
<div class="modal fade" id="importExcelModal" tabindex="-1" role="dialog" aria-labelledby="importExcelModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="importExcelModalLabel">Import Excel Seasoning</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{ route('seasoning.import-excel') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                        <label>File Excel (.xlsx / .xls)</label>
                        <a href="{{ route('seasoning.download-template') }}" class="btn btn-sm btn-outline-primary mb-2">
                            <i class="fas fa-download"></i> Download Template
                        </a>
                        <input type="file" name="file" class="form-control" required>
                        <small class="form-text text-muted">
                            Format kolom: Shift | Tanggal | Jam | Nama Seasoning | Kode Produksi | Berat Per Pack (kg) | Sensori | Kemasan | Keterangan
                        </small>
                    </div>
