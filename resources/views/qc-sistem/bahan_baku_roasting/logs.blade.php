...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-history text-warning"></i> Log Perubahan Bahan Baku Roasting</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <span class="badge badge-info">{{ $bahanBakuRoasting->plan->nama_plan ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-3">
                            <strong>Produk:</strong><br>
                            <span class="badge badge-secondary">{{ $bahanBakuRoasting->produk->nama_produk ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-3">
                            <strong>Shift:</strong><br>
                            <span class="badge badge-primary">Shift {{ $bahanBakuRoasting->shift->shift ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-3">
                            <strong>Tanggal:</strong><br>
                            <span class="badge badge-success">{{ $bahanBakuRoasting->tanggal ? \Carbon\Carbon::parse($bahanBakuRoasting->tanggal)->format('d-m-Y H:i:s') : 'N/A' }}</span>
                        </div>
                    </div>
                    <div class="row mt-3">
                        <div class="col-md-4">
                            <strong>Kode Produksi RM:</strong><br>
                            <span class="badge badge-warning">{{ $bahanBakuRoasting->kode_produksi_rm }}</span>
                        </div>
                        <div class="col-md-4">
                            <strong>Standar Suhu RM:</strong><br>
                            <span class="badge badge-dark">{{ $bahanBakuRoasting->standart_suhu_rm }}</span>
                        </div>
                        <div class="col-md-4">
                            <strong>Aktual Suhu RM:</strong><br>
                            <span class="badge badge-dark">{{ $bahanBakuRoasting->aktual_suhu_rm }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('bahan-baku-roasting.index') }}" class="btn btn-sm btn-secondary">
