...
@section('title', 'Riwayat Perubahan Data - Metal Detector')
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('input-metal-detector.index') }}">Metal Detector</a></li>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <span class="badge badge-info">{{ $item->produk->nama_produk ?? '-' }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Kode Produksi:</strong><br>
                                    <span class="badge badge-secondary">{{ $item->kode_produksi ?? '-' }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Shift:</strong><br>
                                    <span class="badge badge-primary">{{ $item->shift->shift ?? '-' }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Line:</strong><br>
                                    <span class="badge badge-warning">Line {{ $item->line ?? '-' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('input-metal-detector.index') }}" class="btn btn-secondary btn-sm">
                                                ...
                                                <td>
                                                    @if($log->field_yang_diubah && count($log->field_yang_diubah) > 0)
                                                        @foreach($log->field_yang_diubah as $field)
                                                            <span class="text-primary">{{ $log->getNamaFieldSingle($field) }}</span>
