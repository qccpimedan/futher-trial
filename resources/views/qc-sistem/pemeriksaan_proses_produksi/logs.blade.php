...
@section('title', 'Riwayat Perubahan Data - Pemeriksaan Proses Produksi')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <span class="badge badge-info">{{ $item->area->area ?? 'N/A' }}</span>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <strong>Ketidaksesuaian:</strong><br>
                                    <span class="badge badge-warning">{{ $item->ketidaksesuaian_label ?? 'N/A' }}</span>
                                </div>
                            </div>
                            <div class="row mt-2">
                                <div class="col-md-6">
                                    <strong>Disposisi:</strong><br>
                                    <span class="badge badge-success">{{ $item->disposisi_label ?? 'N/A' }}</span>
                                </div>
                                <!-- <div class="col-md-6">
                                    <strong>Uraian Permasalahan:</strong><br>
                                    <span class="text-muted">{{ Str::limit($item->uraian_permasalahan ?? 'N/A', 50) }}</span>
                                </div> -->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('pemeriksaan-proses-produksi.index') }}" class="btn btn-secondary btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($log->field_yang_diubah && count($log->field_yang_diubah) > 0)
                                                        @php
                                                            $fieldNames = \App\Models\PemeriksaanProsesProduksiLog::getFieldNames();
                                                        @endphp
                                                            ...
                                                            @foreach($log->field_yang_diubah as $field)
                                                                @php
                                                                    ...
                                                                    if ($field === 'ketidaksesuaian') {
                                                                        $ketidaksesuaianOptions = \App\Models\PemeriksaanProsesProduksi::getKetidaksesuaianOptions();
                                                                    ...
                                                                    if ($field === 'disposisi') {
                                                                        $disposisiOptions = \App\Models\PemeriksaanProsesProduksi::getDisposisiOptions();
                                                                    ...
                                                                    if ($field === 'tanggal') {
                                                                        if ($nilaiLama && $nilaiLama !== 'Kosong') {
                                                                            $nilaiLama = date('d/m/Y H:i:s', strtotime($nilaiLama));
                                                                        }
                                                                        if ($nilaiBaru && $nilaiBaru !== 'Kosong') {
