...
<div class="content-wrapper">
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1><i class="fas fa-history text-warning"></i> Log Perubahan Pembekuan IQF Penggorengan</h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3">
                            ...
                            <span class="badge badge-info">{{ $pembekuanIqfPenggorengan->plan->nama_plan ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-3">
                            <strong>Suhu Ruang IQF:</strong><br>
                            <span class="badge badge-secondary">{{ $pembekuanIqfPenggorengan->suhu_ruang_iqf }}°C</span>
                        </div>
                        <div class="col-md-3">
                            <strong>Shift:</strong><br>
                            <span class="badge badge-primary">Shift {{ $pembekuanIqfPenggorengan->shift->shift ?? 'N/A' }}</span>
                        </div>
                        <div class="col-md-3">
                            <strong>Tanggal:</strong><br>
                            <span class="badge badge-success">{{ $pembekuanIqfPenggorengan->tanggal ? \Carbon\Carbon::parse($pembekuanIqfPenggorengan->tanggal)->format('d-m-Y H:i:s') : 'N/A' }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-primary card-outline">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('pembekuan-iqf-penggorengan.index') }}" class="btn btn-sm btn-secondary">
                ...
                <div class="card-body">
                    @php
                        $logs = \App\Models\PembekuanIqfPenggorenganLog::with('user')
                            ->where('pembekuan_iqf_penggorengan_uuid', $pembekuanIqfPenggorengan->uuid)
