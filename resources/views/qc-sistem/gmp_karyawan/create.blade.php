...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Tambah Data GMP Karyawan</h1>
                </div>
                <div class="col-sm-6">
                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                <li class="nav-item"><a class="nav-link active" href="#gmp-karyawan" data-toggle="tab">GMP Karyawan</a></li>
                            </ul>
                        </div>
                        <div class="card-body">
                            <div class="tab-content">
                                <div class="active tab-pane" id="gmp-karyawan">
                                @csrf               
                                    ...
                                    <form action="{{ route('gmp-karyawan.store') }}" method="POST">
                                        @csrf
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control @error('id_area') is-invalid @enderror" 
                                                                id="id_area_select_gmp_karyawan" name="id_area" required>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control @error('temuan_ketidaksesuaian') is-invalid @enderror" 
                                                    ...
                                                    @foreach($temuanOptions as $key => $label)
                                                        <option value="{{ $key }}" {{ old('temuan_ketidaksesuaian') == $key ? 'selected' : '' }}>
                                                            {{ $label }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('tindakan_koreksi') is-invalid @enderror" 
                                                            ...
                                                            rows="3" 
                                                            placeholder="Masukkan tindakan koreksi (opsional)">{{ old('tindakan_koreksi') }}</textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control @error('verifikasi') is-invalid @enderror" id="verifikasi" name="verifikasi">
                                                    ...
                                                    <option value="tidak_ok" {{ old('verifikasi') == 'tidak_ok' ? 'selected' : '' }}>Tidak OK</option>
                                                    <option value="ok" {{ old('verifikasi') == 'ok' ? 'selected' : '' }}>OK</option>
                                                </select>
                                                @error('verifikasi')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div id="koreksi-lanjutan-section" style="display: none;">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" 
                                                            class="form-control @error('keterangan_koreksi_lanjutan') is-invalid @enderror" 
                                                            id="keterangan_koreksi_lanjutan" 
                                                            name="keterangan_koreksi_lanjutan" 
                                                            value="{{ old('keterangan_koreksi_lanjutan') }}" 
                                                            placeholder="Catatan">
                                                    @error('keterangan_koreksi_lanjutan')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror

                                                    <input type="text" 
                                                            class="form-control mt-2 @error('tindakan_koreksi_lanjutan') is-invalid @enderror" 
                                                            id="tindakan_koreksi_lanjutan" 
                                                            name="tindakan_koreksi_lanjutan" 
                                                            value="{{ old('tindakan_koreksi_lanjutan') }}" 
                                                            placeholder="Tindakan Koreksi">
                                                    @error('tindakan_koreksi_lanjutan')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror

                                                    <select class="form-control mt-2 @error('koreksi_lanjutan') is-invalid @enderror" id="koreksi_lanjutan" name="koreksi_lanjutan">
                                                        <option value="">-- Pilih --</option>
                                                        <option value="tidak_ok" {{ old('koreksi_lanjutan') == 'tidak_ok' ? 'selected' : '' }}>Tidak OK</option>
                                                        <option value="ok" {{ old('koreksi_lanjutan') == 'ok' ? 'selected' : '' }}>OK</option>
                                                    </select>
