...
@section('title', 'Riwayat Perubahan Data - GMP Karyawan')
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <span class="badge badge-info">{{ $item->nama_karyawan }}</span>
                                </div>
                                <div class="col-md-3">
                                    <strong>Area:</strong><br>
                                    <span class="badge badge-secondary">{{ $item->area->area ?? 'N/A' }}</span>
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <span class="badge badge-success">Shift {{ $item->shift->shift ?? 'N/A' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <a href="{{ route('gmp-karyawan.index') }}" class="btn btn-secondary btn-sm">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($log->field_yang_diubah && count($log->field_yang_diubah) > 0)
                                                        @php
                                                            $fieldNames = \App\Models\GmpKaryawanLog::getFieldNames();
                                                        @endphp
